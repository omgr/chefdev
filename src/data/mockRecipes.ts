...
export const mockRecipes: Recipe[] = [
  {
    ...
    description:
      "Light, fluffy pancakes perfect for a weekend breakfast. The buttermilk makes them extra tender and delicious.",
    category: "Breakfast",
    difficulty: "Easy",
    ...
    instructions: [
      ...
      {
        step: 3,
        text: "Pour wet ingredients into dry ingredients and mix until just combined (lumps are okay!)",
        time: 3,
      },
      {
        step: 4,
        text: "Heat a griddle or large pan over medium heat (about 375°F) and lightly grease",
        time: 2,
      },
      {
        step: 5,
        text: "Pour 1/4 cup batter for each pancake onto the hot griddle",
        time: 1,
      },
      {
        step: 6,
        text: "Cook until bubbles form on surface and edges look dry, then flip and cook until golden brown",
        time: 5,
      },
      {
        step: 7,
        text: "Serve immediately with maple syrup and butter",
        time: 0,
      },
    ],
  ...
  },
  {
    ...
    description:
      "Authentic Italian pasta dish with eggs, cheese, and pancetta. Creamy without using cream!",
    category: "Dinner",
    difficulty: "Medium",
    cuisineType: "Italian",
    prepTime: 10,
    ...
    instructions: [
      {
        step: 1,
        text: "Bring large pot of salted water to boil for pasta",
        time: 5,
      },
      {
        step: 2,
        text: "In a bowl, whisk together eggs and Parmesan cheese",
        time: 2,
      },
      {
        step: 3,
        text: "Cook pancetta in large skillet over medium heat until crispy",
        time: 8,
      },
      {
        step: 4,
        text: "Add garlic to pancetta and cook for 1 minute",
        time: 1,
      },
      {
        step: 5,
        text: "Cook spaghetti according to package directions, reserve 1 cup pasta water",
        time: 10,
      },
      {
        step: 6,
        text: "Remove pan from heat, add drained pasta to pancetta",
        time: 1,
      },
      {
        step: 7,
        text: "Quickly stir in egg mixture, adding pasta water to create creamy sauce",
        time: 2,
      },
      {
        step: 8,
        text: "Season with salt and pepper, garnish with parsley",
        time: 1,
      },
    ],
  ...
  },
  {
    ...
    description:
      "Classic chewy chocolate chip cookies that everyone loves. Perfect for dessert or afternoon snack.",
    category: "Dessert",
    difficulty: "Easy",
    cuisineType: "American",
    prepTime: 15,
    ...
    instructions: [
      ...
      {
        step: 9,
        text: "Cool on baking sheets for 2 minutes, then transfer to wire rack",
        time: 2,
      },
    ],
  ...
  },
  {
    ...
    title: "Greek Salad",
    description:
      "Fresh and healthy Mediterranean salad with crisp vegetables, feta, and olives.",
    category: "Lunch",
    difficulty: "Easy",
    cuisineType: "Greek",
    prepTime: 15,
    ...
    instructions: [
      {
        step: 1,
        text: "Combine cucumber, tomatoes, onion, and bell pepper in large bowl",
        time: 5,
      },
      { step: 2, text: "Add olives and feta cheese", time: 2 },
      {
        step: 3,
        text: "In small bowl, whisk together olive oil, vinegar, and oregano",
        time: 2,
      },
      ...
      {
        step: 6,
        text: "Let sit for 10 minutes before serving for flavors to meld",
        time: 10,
      },
    ],
  ...
  },
  {
    ...
    description:
      "Quick and flavorful Asian-inspired stir-fry with tender chicken and crisp vegetables.",
    category: "Dinner",
    difficulty: "Easy",
    cuisineType: "Chinese",
    prepTime: 20,
    ...
    instructions: [
      {
        step: 1,
        text: "Mix cornstarch with chicken broth in small bowl, set aside",
        time: 1,
      },
      {
        step: 2,
        text: "Heat 1 tbsp oil in wok or large skillet over high heat",
        time: 2,
      },
      {
        step: 3,
        text: "Cook chicken until no longer pink, remove and set aside",
        time: 5,
      },
      {
        step: 4,
        text: "Add remaining oil, cook vegetables until tender-crisp",
        time: 5,
      },
      { step: 5, text: "Add garlic and ginger, cook for 30 seconds", time: 1 },
      {
        step: 6,
        text: "Return chicken to pan, add soy sauce and oyster sauce",
        time: 1,
      },
      {
        step: 7,
        text: "Stir in cornstarch mixture, cook until sauce thickens",
        time: 2,
      },
  ...
  },
  {
    ...
    instructions: [
      {
        step: 1,
        text: "Preheat oven to 350°F (175°C). Grease 9x5 loaf pan",
        time: 5,
      },
      ...
      {
        step: 4,
        text: "Sprinkle baking soda and salt over mixture, stir in",
        time: 1,
      },
      {
        step: 5,
        text: "Add flour, mix until just incorporated (don't overmix)",
        time: 2,
      },
      ...
      {
        step: 8,
        text: "Bake for 60 minutes until toothpick comes out clean",
        time: 60,
      },
      {
        step: 9,
        text: "Cool in pan for 10 minutes, then turn out onto wire rack",
        time: 10,
      },
    ],
